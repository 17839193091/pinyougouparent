...
public class UserServiceImpl implements UserService {
	...
	public void createSmsCode(final String phone) {
		...
		String smsCode = Double.toString(random);
	...
	public Boolean checkSmsCode(String phone, String code) {
		String smsCode = String.valueOf(redisTemplate.boundHashOps("smsCode").get(phone));
		if (!"null".equals(smsCode) && code.equals(smsCode)){
			return true;
		}
		return false;
	}
